...
public class MetricDataParserTest {
    ...
    public void parseNodeDataTestSystemMetrics() throws Exception{
        ...
        monitorContextConfiguration.setMetricXml("/Users/bhuvnesh.kumar/repos/appdynamics/extensions/solr-monitoring-extension/src/test/resources/xml/SystemAndSystem.xml", Stat.Stats.class);

...
public class CacheMetricsTest {
    ...
    public void populateStatsTest_DocumentCacheMetrics () {
        ...
        Map<String, Long> metrics = documentCacheMetricsPopulator.populateStats(map);
    ...
    public void populateStatsTest_FieldCacheMetrics() {
        ...
        Map<String, Long> metrics = fieldCacheMetricsPopulator.populateStats(map);
        Assert.assertTrue(metrics.size() == 3);
    ...
    public void populateStatsTest_QueryCacheMetrics() {
        ...
        Map<String, Long> metrics = queryCacheMetricsPopulator.populateStats(map);
        Assert.assertTrue(metrics.size() == 3);
        ...
        Assert.assertTrue(metrics.get(queryCacheMetricPath + "HitRatio %").equals(new Long("4634978072750194688")));
        Assert.assertTrue(metrics.get(queryCacheMetricPath + "CacheSize (Bytes)").equals(new Long("4607182418800017408")));
            Assert.assertTrue(metrics.get(queryCacheMetricPath + "HitRatioCumulative %").equals(new Long("4634978072750194688")));
    }
    ...
    public void populateStatsTest_FilterCacheMetrics() {
        ...
        Map<String, Long> metrics = filterCacheMetricsPopulator.populateStats(map);
        Assert.assertTrue(metrics.size() == 3);

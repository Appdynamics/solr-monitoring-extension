...
public class NewSolrStats {
    CloseableHttpClient httpClient;
    String serverName;
    String serverUrl;
    String contextRoot = "/solr/";

    NewSolrStats(Map server, String contextRoot, CloseableHttpClient httpClient) {
        this.httpClient = httpClient;
        this.serverName = (String) server.get("name");
